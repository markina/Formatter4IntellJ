package com.jetbrains.formatter.idea;
...
import com.intellij.psi.formatter.java.*;
...
public abstract class IIIAbstractJavaBlock extends AbstractBlock implements JavaBlock, ReservedWrapsProvider {

  private static final Logger LOG = Logger.getInstance("#com.intellij.psi.formatter.java.IIIAbstractJavaBlock");
  ...
  private IIIAbstractJavaBlock myParentBlock;
  ...
  private BlockFactory myBlockFactory = new BlockFactory() {
    ...
    public Block createBlock(ASTNode node, Indent indent, Alignment alignment, Wrap wrap) {
      return new IIISimpleJavaBlock(node, wrap, AlignmentStrategy.wrap(alignment), indent, mySettings, myJavaSettings);
    }
  ...
  protected IIIAbstractJavaBlock(@NotNull final ASTNode node,
                              final Wrap wrap,
  ...
  private IIIAbstractJavaBlock(@NotNull ASTNode ignored,
  ...
  private Block createJavaBlock(@NotNull ASTNode child,
    ...
    if (child instanceof LeafElement) {
      ...
      final IIISimpleJavaBlock simpleJavaBlock = new IIISimpleJavaBlock(child, wrap, alignmentStrategy, actualIndent, settings, javaSettings);
  ...
  public static Block newJavaBlock(@NotNull ASTNode child,
    ...
    return new IIIAbstractJavaBlock(child, settings, javaSettings) {
      @Override
  ...
  protected ASTNode processChild(@NotNull final List<Block> result,
    ...
    if (childType == JavaElementType.METHOD_CALL_EXPRESSION) {
      ...
      {
        result.add(new IIISimpleJavaBlock(child, defaultWrap, alignmentStrategy, childIndent, mySettings, myJavaSettings));
      }
  ...
  private Wrap getModifierListWrap() {
    IIIAbstractJavaBlock parentBlock = getParentBlock();
    if (parentBlock != null) {
  ...
  protected Wrap arrangeChildWrap(final ASTNode child, Wrap defaultWrap) {
    //when detecting indent we do not care about wraps
    return isBuildIndentsOnly() ? null : myWrapManager.arrangeChildWrap(child, myNode, mySettings, myJavaSettings, defaultWrap, null);
  ...
  private boolean isAfterCodeBlock(final int newChildIndex) {
    ...
    return blockBefore instanceof IIICodeBlockBlock;
  }
  ...
  public IIIAbstractJavaBlock getParentBlock() {
    return myParentBlock;
  }

  public void setParentBlock(@NotNull IIIAbstractJavaBlock parentBlock) {
