...
public class IIIBlockContainingJavaBlock extends IIIAbstractJavaBlock {
  ...
  public IIIBlockContainingJavaBlock(ASTNode node,
                                  Wrap wrap,
                                  Alignment alignment,
                                  Indent indent,
  ...
  public IIIBlockContainingJavaBlock(ASTNode child,
                                  Indent indent,
  ...
  protected List<Block> buildChildren() {
    ...
    for (Block block : result) {
      if (block instanceof IIIAbstractJavaBlock) {
        ((IIIAbstractJavaBlock)block).setParentBlock(this);
      }
    }
